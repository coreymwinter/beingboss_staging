...
<div class="mobileshow">
			<div class="row">
				<div class="col-md-6 mobileusernav">
    				<input type="checkbox" id="show-menu-user" role="button">
    				<label for="show-menu-user" class="show-menu-user"><i class="fa fa-bars" aria-hidden="true"></i> Profile Menu</label>
					<ul id="mobileusermenu">
						<?php
						while ( bp_nouveau_nav_items() ) :
							bp_nouveau_nav_item();
						?>
