...
function add_theme_scripts() {
  ...
  wp_enqueue_style( 'directory-styles', get_stylesheet_directory_uri() . '/css/directory-styles.css', array(), filemtime( get_stylesheet_directory() . '/css/directory-styles.css' ) );
 ...
 */
class BB_Bootstrap_Navwalker extends Walker_Nav_Menu {
	/**
