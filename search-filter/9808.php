			...
			<article class="vacationitem" id="post-<?php the_ID(); ?>" <?php post_class(); ?> >
				...
				<?php endif; ?>
					<div class="vacationitemcontent">
						<h5><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><span class="vacationitemtitle"> <?php the_title(); ?></span></a></h5>
						<a href="<?php the_permalink(); ?>" class="vacationitemreadmore">VIEW MORE</a>
					</div> 
			</article>
